    ...
    <>
      {!user ? null : (
        <div className="flex flex-col justify-center items-center h-[50vh] mb-20">
          ...
          <Link href="/Create-Blogs" className="bg-red-400 px-6 py-2 text-white rounded" >Create Blogs</Link>
          <Link href="/Manage-Blogs" className="bg-red-400 px-6 py-2 text-white rounded" >Manage Blogs</Link>
          </div>
        </div>
      )}
    </>
